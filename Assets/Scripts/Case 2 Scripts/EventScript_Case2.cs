...
public class EventScript_Case2 : MonoBehaviour
{
    ...
    public string GetQuestionText(int index)
    {
        ...
        "All members of the pharmacy staff can assist in increasing awareness of NIHB coverage, both among indigenous patients and pharmacy professionals.", 
        "As a Registered First Nation person, Jordyn can access health care benefits at the pharmacy, such as access to over-the-counter and prescription medicine for minor ailments, coverage for gauze and tape if prescribed by a nurse practitioner, and access to physiotherapy.",
    ...
    public string GetExplanationText(int index)
    {
        ...
        "Eligible First Nations and Inuit can access health care benefits at the pharmacy, including: \n1) Access to over-the-counter and prescription medicine that are covered by NHIB when recommended or prescribed by a RPh.\n2) Coverage for gauze/tape if prescribed by a nurse practitioner \n3) Coverage for crutches, and possibly other mobility equipment if prescribed by a physician.\n\nHowever, NIHB does not cover access to physiotherapy.",
